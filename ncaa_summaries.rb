...
"team_id", "team_name", "jersey_number", "player_id", "player_name", "player_url",
  "class_year", "gp", "gs",
"gp", "gs", "Goals", "Assists", "Points", "Shots", "Shot PCT", "SOG", "SOG PCT", "GWG", "EMO G", "Man-Down G", "GB", "TO", "CT", "FOW", "FOs Taken", "FO%", "Pen", "Pen Time", "GGP", "GGS", "G Min", "Goals Allowed", "GAA", "Saves", "Save Pct", "RC", "YC", "Clears Suc", "Clears Att", "Clear Pct"]

ncaa_team_summaries << ["year", "year_id",
"team_id", "team_name",
"jersey_number", "team/opp", "player_name", "player_url", "class_year",
"gp", "gs", "Goals", "Assists", "Points", "Shots", "Shot PCT", "SOG", "SOG PCT", "GWG", "EMO G", "Man-Down G", "GB", "TO", "CT", "FOW", "FOs Taken", "FO%", "Pen", "Pen Time", "GGP", "GGS", "G Min", "Goals Allowed", "GAA", "Saves", "Save Pct", "RC", "YC", "Clears Suc", "Clears Att", "Clear Pct"]
