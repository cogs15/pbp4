...
truncate `16ncaa_merged_pbp`;

insert into `16ncaa_merged_pbp` (team_id, team_name, opponent_id, opponent_name, game_id, period_id, time, section_id, event_id, play_text)
...
left join 16ncaa_pbp pbp on periods.game_id=pbp.game_id
left join 16ncaa_periods periods2 on periods.game_id = periods2.game_id
where pbp.team_text != ""
