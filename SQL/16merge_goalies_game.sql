...
truncate `16ncaa_player_game_stats`;

insert into `16ncaa_player_game_stats` (year, game_date, game_id, section_id, player_id, player_name, start_position, goals, assists, points, shots, sog, emo_g, gb, turnovers, ct, fow, fo_taken, pen, pen_time, g_min, goals_allowed, saves)
...
where b.player_name<>'TOTALS' and b.player_name<>'Team';
           ...
           update 16ncaa_player_game_stats t1, (select game_id, team_id, section_id from 16ncaa_periods) t2
         ...
         update 16ncaa_player_game_stats t1, (select team_id, team_name, year from 16ncaa_rosters) t2
       ...
       update 16ncaa_player_game_stats t1, (select player_id, position, year from 16ncaa_player_stats) t2
