...
insert into `ncaa_game_stats` (year_id, year, game_date, division, team_id, opponent_id, game_id, goals,  opp_goals, assists, opp_assists, turnovers, opp_turnovers, possessions, opp_possessions, clears_suc, opp_clears_suc, clears_att, opp_clears_att, shots, opp_shots, groundballs, opp_groundballs, fow, fol)
...
set t1.adj_o_efficiency = t1.efficiency * .33/t1.opp_d_eff,
t1.adj_d_efficiency = t1.opp_efficiency * .33/t1.opp_o_eff;
