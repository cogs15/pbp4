...
insert into `ncaa_game_stats` (year_id, year, game_date, division_id, team_id, opponent_id, game_id, goals,  opp_goals, assists, opp_assists, turnovers, opp_turnovers, possessions, opp_possessions, clears_suc, opp_clears_suc, clears_att, opp_clears_att, shots, opp_shots, groundballs, opp_groundballs, fow, fol)
...
insert into `ncaa_efficiency` (year_id, year, division_id, team_id, team_name, clear_pct, ride_pct, a_to, opp_a_to, goals,  opp_goals, shots, opp_shots, possessions, opp_possessions, iso_gb, opp_iso_gb, fow, fol)
...
update ncaa_efficiency t1, (select team_id, year, avg(opp_avg_poss_pct) as avgposs from ncaa_game_stats group by team_id, year) t2
